...
function applyQueryParseOutput(query, context, options = {}) {
    ...
    if (context.relations) {
        ...
        if (locter.isObject(options.relations)) {
...
function applyQuery(query, input, options = {}) {
    ...
    const output = applyQueryParseOutput(query, rapiq.parseQuery(input, options), options);
    return {
        ...output,
...
exports.CodeTransformation = CodeTransformation;
...
exports.EnvironmentVariableName = EnvironmentVariableName;
