...
export declare function applyQueryParseOutput<T extends ObjectLiteral = ObjectLiteral>(query: SelectQueryBuilder<T>, context: ParseOutput, options?: QueryApplyOptions<T>): ParseOutput;
