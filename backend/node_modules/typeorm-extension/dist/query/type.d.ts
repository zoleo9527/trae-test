...
import type { QueryFieldsApplyOptions, QueryFiltersApplyOptions, QueryPaginationApplyOptions, QueryRelationsApplyOptions, QuerySortApplyOptions } from './parameter';
export type QueryApplyOptions<T extends ObjectLiteral = ObjectLiteral> = {
    defaultPath?: string;
