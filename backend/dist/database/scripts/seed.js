...
async function seedDatabase() {
    try {
        ...
        const memberRepository = data_source_1.AppDataSource.getRepository(entities_1.Member);
        console.log('创建默认用户...');
        ...
        const users = [
            ...
            },
            {
                ...
                realName: '门店经理',
                phone: '13800000002',
                role: entities_1.UserRole.MANAGER,
            },
            {
                username: 'sales',
                password: hashedPassword,
                realName: '销售员',
                phone: '13800000003',
                role: entities_1.UserRole.SALES,
            },
            {
                username: 'workshop',
                password: hashedPassword,
                realName: '工坊师傅',
                phone: '13800000004',
                role: entities_1.UserRole.WORKSHOP,
            },
            {
                username: 'cs',
                password: hashedPassword,
                realName: '客服专员',
                phone: '13800000005',
                role: entities_1.UserRole.CUSTOMER_SERVICE,
            },
        ];
        ...
        const sampleMembers = [
            {
                ...
                phone: '13900000001',
                gender: '男',
                level: entities_1.MemberLevel.GOLD,
            ...
            },
            {
                ...
                phone: '13900000002',
                gender: '女',
                level: entities_1.MemberLevel.PLATINUM,
            ...
            },
            {
                ...
                phone: '13900000003',
                gender: '女',
                level: entities_1.MemberLevel.SILVER,
