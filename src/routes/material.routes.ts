...
router.get('/', authenticate, validate(listSchema), async (req: AuthRequest, res, next) => {
  try {
...
router.patch('/:id/status', authenticate, validate(statusSchema), async (req: AuthRequest, res, next) => {
  try {
...
router.patch('/:id/assign', authenticate, validate(assignSchema), async (req: AuthRequest, res, next) => {
  try {
