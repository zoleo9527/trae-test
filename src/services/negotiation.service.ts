...
export class NegotiationService {
  ...
  async updateStatus(data: UpdateNegotiationStatusRequest) {
    ...
    const statusTransitions: Record<string, NegotiationStatus[]> = {
      [NEGOTIATION_STATUS.DRAFT]: [NEGOTIATION_STATUS.MANAGER_REVIEW],
      [NEGOTIATION_STATUS.SUBMITTED]: [NEGOTIATION_STATUS.MANAGER_REVIEW, NEGOTIATION_STATUS.REJECTED],
      [NEGOTIATION_STATUS.MANAGER_REVIEW]: [
        NEGOTIATION_STATUS.APPROVED,
        NEGOTIATION_STATUS.REJECTED,
        NEGOTIATION_STATUS.REWORK_REQUIRED,
      ],
      [NEGOTIATION_STATUS.APPROVED]: [NEGOTIATION_STATUS.IMPLEMENTING, NEGOTIATION_STATUS.REJECTED],
      [NEGOTIATION_STATUS.REJECTED]: [NEGOTIATION_STATUS.REWORK_REQUIRED, NEGOTIATION_STATUS.DRAFT],
      [NEGOTIATION_STATUS.REWORK_REQUIRED]: [
        NEGOTIATION_STATUS.MANAGER_REVIEW,
        NEGOTIATION_STATUS.DRAFT,
      ],
