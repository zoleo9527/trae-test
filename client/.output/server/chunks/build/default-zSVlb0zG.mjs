...
import { defineComponent, ref, mergeProps, unref, computed, withCtx, openBlock, createBlock, createVNode, createCommentVNode, toDisplayString, createTextVNode, useSSRContext } from 'vue';
...
import { _ as __nuxt_component_2, c as useRoute } from './server.mjs';
import { u as useAuthStore } from './auth-BO_zE_6L.mjs';
import { u as useDataStore, m as mockUsers } from './data-CvF3Pjf4.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function getRoleUser(role) {
      ...
      return (user == null ? void 0 : user.name) || "";
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((_a = unref(authStore).currentUser) == null ? void 0 : _a.avatar) {
        ...
        _push(`<div class="w-8 h-8 md:w-9 md:h-9 rounded-full bg-gray-200 flex items-center justify-center"><span class="text-sm font-medium text-gray-600">${ssrInterpolate(((_c = (_b = unref(authStore).currentUser) == null ? void 0 : _b.name) == null ? void 0 : _c.charAt(0)) || "U")}</span></div>`);
      }
      _push(`<div class="hidden md:block text-left"><p class="text-sm font-medium text-gray-900">${ssrInterpolate(((_d = unref(authStore).currentUser) == null ? void 0 : _d.name) || "\u7528\u6237")}</p><p class="text-xs text-gray-500">${ssrInterpolate(unref(roleLabel))}</p></div></button>`);
      if (unref(showUserMenu)) {
        ...
        if ((_e = unref(authStore).currentUser) == null ? void 0 : _e.avatar) {
...
//# sourceMappingURL=default-zSVlb0zG.mjs.map
