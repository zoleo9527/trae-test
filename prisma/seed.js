...
async function main() {
    ...
    const [owner, advisor, tech] = await Promise.all([
        prisma.user.upsert({
            ...
            create: {
                username: 'owner',
                password: (0, auth_1.hashPassword)('123456'),
                name: '张老板',
                role: client_1.Role.STORE_OWNER,
                phone: '13800138001',
            },
        }),
        prisma.user.upsert({
            ...
            create: {
                ...
                password: (0, auth_1.hashPassword)('123456'),
                name: '李顾问',
                role: client_1.Role.RENTAL_ADVISOR,
                phone: '13800138002',
            },
        }),
        prisma.user.upsert({
            ...
            create: {
                ...
                password: (0, auth_1.hashPassword)('123456'),
                name: '王师傅',
                role: client_1.Role.MAINTENANCE_TECH,
                phone: '13800138003',
            },
        }),
    ]);
    ...
    const instruments = await Promise.all([
        prisma.instrument.upsert({
            ...
            create: {
                ...
                rentalPrice: 25,
                depositAmount: 1000,
                status: client_1.InstrumentStatus.AVAILABLE,
        ...
        prisma.instrument.upsert({
            ...
            create: {
                ...
                rentalPrice: 300,
                depositAmount: 15000,
                status: client_1.InstrumentStatus.IN_MAINTENANCE,
        ...
        prisma.instrument.upsert({
            ...
            create: {
                ...
                rentalPrice: 180,
                depositAmount: 10000,
                status: client_1.InstrumentStatus.DAMAGED,
    ...
    const rental1 = await prisma.rental.create({
        data: {
            rentalNo: (0, utils_1.generateOrderNo)('RL'),
            ...
            depositAmount: 1000,
            totalRentalFee: 375,
            status: client_1.RentalStatus.SETTLED,
            ...
            deposit: {
                create: {
                    depositNo: (0, utils_1.generateOrderNo)('DP'),
                    amount: 1000,
                    status: client_1.DepositStatus.REFUNDED,
                    refundAmount: 1000,
                    deductAmount: 0,
                    deductReason: null,
    ...
    await prisma.instrument.update({
        ...
        data: { status: client_1.InstrumentStatus.AVAILABLE },
    });
    await prisma.auditLog.createMany({
        data: [
            {
                action: client_1.AuditAction.RENTAL_CREATE,
                entityType: 'RENTAL',
                entityId: rental1.id,
                ...
                oldValue: null,
                newValue: { status: client_1.RentalStatus.ACTIVE, dailyRate: 25, depositAmount: 1000 },
                changes: { status: { old: null, new: 'ACTIVE' } },
            },
            {
                action: client_1.AuditAction.RENTAL_RETURN,
                entityType: 'RENTAL',
                entityId: rental1.id,
                ...
                oldValue: { status: client_1.RentalStatus.ACTIVE },
                newValue: { status: client_1.RentalStatus.RETURNED, actualEndDate: scenario1Date.toISOString() },
                changes: { status: { old: 'ACTIVE', new: 'RETURNED' } },
            },
            {
                action: client_1.AuditAction.DEPOSIT_REFUND,
                entityType: 'DEPOSIT',
                ...
                createdAt: scenario1Date,
                oldValue: { status: client_1.DepositStatus.HELD, amount: 1000 },
                newValue: { status: client_1.DepositStatus.REFUNDED, refundAmount: 1000, deductAmount: 0 },
            ...
            },
            {
                ...
                operatorRole: owner.role,
                createdAt: scenario1Date,
                oldValue: { status: client_1.RentalStatus.RETURNED },
                newValue: { status: client_1.RentalStatus.SETTLED },
        ...
        data: {
            ...
            deposit: {
                create: {
                    depositNo: (0, utils_1.generateOrderNo)('DP'),
                    amount: 8000,
                    status: client_1.DepositStatus.PARTIAL_REFUNDED,
                    refundAmount: 6500,
                    deductAmount: 1500,
            ...
            damageClaims: {
                create: {
                    claimNo: (0, utils_1.generateOrderNo)('DM'),
                    instrumentId: instruments[1].id,
                    severity: client_1.DamageSeverity.MINOR,
                    description: '琴颈2cm划痕，面板磕碰凹陷',
                    estimatedCost: 1500,
                    status: client_1.DamageClaimStatus.CLOSED,
    ...
    const maintenance2 = await prisma.maintenance.create({
        data: {
            maintenanceNo: (0, utils_1.generateOrderNo)('MT'),
            instrumentId: instruments[1].id,
        ...
        data: [
            {
                ...
                oldValue: null,
                newValue: { status: client_1.RentalStatus.ACTIVE, dailyRate: 150, depositAmount: 8000 },
                changes: { status: { old: null, new: 'ACTIVE' } },
            },
            {
                action: client_1.AuditAction.RENTAL_RETURN,
                ...
                oldValue: { status: client_1.RentalStatus.ACTIVE },
                newValue: { status: client_1.RentalStatus.RETURNED },
                changes: { status: { old: 'ACTIVE', new: 'RETURNED' } },
            },
            {
                action: client_1.AuditAction.DAMAGE_REPORT,
                ...
                createdAt: scenario2Date,
                oldValue: null,
                newValue: { status: client_1.DamageClaimStatus.PENDING, severity: client_1.DamageSeverity.MINOR, estimatedCost: 1500 },
                changes: { status: { old: null, new: 'PENDING' } },
            },
            {
                action: client_1.AuditAction.DAMAGE_CONFIRM,
                entityType: 'DAMAGE_CLAIM',
                entityId: rental2.damageClaims[0].id,
                ...
                operatorRole: owner.role,
                createdAt: scenario2Date,
                oldValue: { status: client_1.DamageClaimStatus.PENDING, customerDispute: false },
                newValue: { status: client_1.DamageClaimStatus.CONFIRMED, liabilityParty: 'CUSTOMER' },
                changes: { status: { old: 'PENDING', new: 'CONFIRMED' } },
            },
            {
                action: client_1.AuditAction.MAINTENANCE_CREATE,
            ...
            {
                action: client_1.AuditAction.MAINTENANCE_COMPLETE,
                entityType: 'MAINTENANCE',
                entityId: maintenance2.id,
            ...
            {
                action: client_1.AuditAction.DEPOSIT_DEDUCT,
                entityType: 'DEPOSIT',
                ...
                oldValue: { status: client_1.DepositStatus.HELD, amount: 8000 },
                newValue: { status: client_1.DepositStatus.PARTIAL_REFUNDED, refundAmount: 6500, deductAmount: 1500 },
            ...
            },
            {
                ...
                operatorRole: owner.role,
                createdAt: new Date(scenario2Date.getTime() + 1 * 24 * 60 * 60 * 1000),
                oldValue: { status: client_1.DamageClaimStatus.CONFIRMED },
                newValue: { status: client_1.DamageClaimStatus.CLOSED },
        ...
        data: {
            ...
            deposit: {
                create: {
                    depositNo: (0, utils_1.generateOrderNo)('DP'),
                    amount: 5000,
                    status: client_1.DepositStatus.DEDUCTED,
                    refundAmount: 0,
                    deductAmount: 5000,
            ...
            damageClaims: {
                create: {
                    claimNo: (0, utils_1.generateOrderNo)('DM'),
                    instrumentId: instruments[2].id,
                    severity: client_1.DamageSeverity.MODERATE,
        ...
        data: [
            {
                ...
                oldValue: null,
                newValue: { status: client_1.RentalStatus.ACTIVE },
                changes: { status: { old: null, new: 'ACTIVE' } },
            },
            {
                action: client_1.AuditAction.RENTAL_RETURN,
            ...
            },
            {
                ...
                createdAt: scenario3Date,
                oldValue: null,
                newValue: { status: client_1.DamageClaimStatus.PENDING },
                changes: { status: { old: null, new: 'PENDING' } },
            },
            {
                action: client_1.AuditAction.DAMAGE_DISPUTE,
                entityType: 'DAMAGE_CLAIM',
                entityId: rental3.damageClaims[0].id,
                ...
                oldValue: { status: client_1.DamageClaimStatus.PENDING, customerDispute: false },
                newValue: { status: client_1.DamageClaimStatus.DISPUTED, customerDispute: true },
                changes: { status: { old: 'PENDING', new: 'DISPUTED' } },
            },
            {
                action: client_1.AuditAction.DAMAGE_REJECT,
                entityType: 'DAMAGE_CLAIM',
                entityId: rental3.damageClaims[0].id,
                ...
                oldValue: { status: client_1.DamageClaimStatus.DISPUTED },
                newValue: { status: client_1.DamageClaimStatus.REJECTED },
            ...
            },
            {
                ...
                oldValue: { status: client_1.DepositStatus.HELD, amount: 5000 },
                newValue: { status: client_1.DepositStatus.DEDUCTED, refundAmount: 0, deductAmount: 5000 },
            ...
            },
            {
                ...
                operatorRole: owner.role,
                createdAt: new Date(scenario3Date.getTime() + 3 * 24 * 60 * 60 * 1000),
                oldValue: { status: client_1.DamageClaimStatus.REJECTED },
                newValue: { status: client_1.DamageClaimStatus.CLOSED },
                changes: { status: { old: 'REJECTED', new: 'CLOSED' } },
            },
            {
                action: client_1.AuditAction.NOTE_ADD,
                entityType: 'DAMAGE_CLAIM',
                entityId: rental3.damageClaims[0].id,
    ...
    await prisma.auditLog.createMany({
        data: [
            ...
            },
            {
                ...
                createdAt: scenario4Date,
                oldValue: null,
                newValue: { status: client_1.DamageClaimStatus.PENDING, estimatedCost: 2000 },
                changes: { status: { old: null, new: 'PENDING' } },
            },
            {
                action: client_1.AuditAction.DAMAGE_DISPUTE,
            ...
            {
                action: client_1.AuditAction.DAMAGE_RESOLVE,
                entityType: 'DAMAGE_CLAIM',
                entityId: rental4.damageClaims[0].id,
                ...
                oldValue: { status: client_1.DamageClaimStatus.DISPUTED, estimatedCost: 2000, liabilityParty: null },
                newValue: { status: client_1.DamageClaimStatus.RESOLVED, finalCost: 1000, liabilityParty: 'SHARED' },
            ...
            },
            {
                ...
                oldValue: { status: client_1.DepositStatus.HELD, amount: 10000 },
                newValue: { status: client_1.DepositStatus.PARTIAL_REFUNDED, refundAmount: 9000, deductAmount: 1000 },
                changes: { status: { old: 'HELD', new: 'PARTIAL_REFUNDED' } },
            },
            {
                action: client_1.AuditAction.STATUS_CHANGE,
                ...
                operatorRole: owner.role,
                createdAt: new Date(scenario4Date.getTime() + 2 * 24 * 60 * 60 * 1000),
                oldValue: { status: client_1.DamageClaimStatus.RESOLVED },
                newValue: { status: client_1.DamageClaimStatus.CLOSED },
    ...
    const rental6 = await prisma.rental.create({
        data: {
            ...
            depositAmount: 1000,
            totalRentalFee: 250,
            status: client_1.RentalStatus.OVERDUE,
            ...
            deposit: {
                create: {
                    depositNo: (0, utils_1.generateOrderNo)('DP'),
                    amount: 1000,
                    status: client_1.DepositStatus.HELD,
                    refundAmount: 0,
                    deductAmount: 0,
                    deductReason: null,
                    settledAt: null,
    ...
    await prisma.instrument.update({
        where: { id: instruments[0].id },
        data: { status: client_1.InstrumentStatus.RENTED },
    });
    await prisma.auditLog.createMany({
        data: [
            {
                ...
                oldValue: null,
                newValue: { status: client_1.RentalStatus.ACTIVE, dailyRate: 25 },
                changes: { status: { old: null, new: 'ACTIVE' } },
            },
            {
                action: client_1.AuditAction.STATUS_CHANGE,
                ...
                oldValue: { status: client_1.RentalStatus.ACTIVE },
                newValue: { status: client_1.RentalStatus.OVERDUE },
        ...
        data: {
            ...
            deposit: {
                create: {
                    depositNo: (0, utils_1.generateOrderNo)('DP'),
                    amount: 8000,
                    status: client_1.DepositStatus.DISPUTED,
                    refundAmount: 0,
                    deductAmount: 0,
                    deductReason: null,
                    settledAt: null,
            ...
            damageClaims: {
                create: {
                    ...
                    estimatedCost: 2500,
                    status: client_1.DamageClaimStatus.DISPUTED,
    ...
    await prisma.instrument.update({
        where: { id: instruments[1].id },
        data: { status: client_1.InstrumentStatus.DAMAGED },
    });
    await prisma.auditLog.createMany({
        data: [
            {
            ...
            {
                action: client_1.AuditAction.DEPOSIT_DISPUTE,
                entityType: 'DEPOSIT',
                ...
                oldValue: { status: client_1.DepositStatus.HELD },
                newValue: { status: client_1.DepositStatus.DISPUTED },
